...
% This is an example for running the function tree_mcLogisticR
%
%  Problem:
%
...
tic;
[x1, c1, funVal1, ValueL1]= tree_mcLogisticR(A, y, z, opts);
toc;
...
tic;
[x2, c2, funVal2, ValueL2]= tree_mcLogisticR(A, y, z, opts);
toc;
