...
% This is an example for running the function tree_mcLeastR
%
%  Problem:
%
...
m=50;  n=80;       % The data matrix is of size m x n
k=100;
...
tic;
[x1, funVal1, ValueL1]= tree_mcLeastR(A, y, z, opts);
toc;
...
tic;
[x2, funVal2, ValueL2]= tree_mcLeastR(A, y, z, opts);
toc;
