...
% This is an example for running the function glLeastR
%
%  Problem:
%
...
ind=[0 100, 400, 800, 1000];   % the indices for the groups
...
tic;
[x1, funVal1, ValueL1]= glLeastR(A, y, rho, opts);
toc;
...
tic;
[x2, funVal2, ValueL2]= glLeastR(A, y, rho, opts);
toc;
...
opts.tFlag=2; opts.tol= funVal1(end);
tic;
[x3, funVal3, ValueL3]= glLeastR(A, y, rho, opts);
toc;
...
% opts.fName='glLeastR';    % set the function name to 'glLeastR'
